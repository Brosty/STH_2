    ...
    if (typeof l.STH === 'function') {
        ...
        l.STH = function() {
            ...
            if (result && typeof result === 'object') {
                ...
                // Override auth functions to always return premium status
                if (result.authS && typeof result.authS === 'function') {
                    ...
                    result.authS = function() {
                        ...
                        const premiumAuth = authResult || {};
                        premiumAuth.isPay = true;
                        premiumAuth.premium = true;
                        premiumAuth.active = true;
                        premiumAuth.sessionID = premiumAuth.sessionID || 'dummy';
                        premiumAuth.currency = premiumAuth.currency || 1;
                        return premiumAuth;
                    };
                }
        ...
        for (let prop in originalSTH) {
            if (originalSTH.hasOwnProperty(prop)) {
                l.STH[prop] = originalSTH[prop];
            }
        }
        
        console.log('License Bypass: STH function hooked successfully');
    }
}, 100);}(this);